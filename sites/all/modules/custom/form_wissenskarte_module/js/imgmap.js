...
imgmap.prototype.loadImage = function(img, imgw, imgh) {
	...
	if (typeof img == 'string') {
		...
		if (typeof this.pic == 'undefined' || this.pic == null) {
			this.pic = document.createElement('IMG');
			this.pic_container.appendChild(this.pic);
			//event handler hooking - only at the first load
			this.removeEvent(this.pic, 'mousedown', function(){});
			this.removeEvent(this.pic, 'mouseup',   function(){});
			this.removeEvent(this.pic, 'mousemove', function(){});
